...
# some noisy data
noiseSD=10
LVnoise10=LVperfect+rnorm(prod(dim(truth)),0,noiseSD)
message("LVnoise10")
print(LVnoise10)
...
print(LVpreyNoise10)
noiseSD=30
LVnoise30=LVperfect+rnorm(prod(dim(truth)),0,noiseSD)
message("LVnoise30")
print(LVnoise30)
...
dump(c("LVperfect","LVprey","LVpreyNoise10","LVnoise10","LVnoise30","LVnoise3010","LVirregular","LVirregularNoise10"),"LVdata.R")
